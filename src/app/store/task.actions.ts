...
export const markTaskAsPending = createAction('[Task] Mark Task as Pending', props<{ id: number }>());export const addPersonToTask = createAction('[Task] Add Person to Task', props<{ taskId: number, person: Person }>());
